...
var Logo_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "logo-card" }, _attrs))} data-v-f6b514d7>`);
			_push(ssrRenderComponent(_component_router_link, { to: "/" }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<h1 data-v-f6b514d7${_scopeId}>Cnkrru</h1>`);
...
var Logo_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Logo_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-f6b514d7"]]);
//#endregion
...
var ImmersiveReading_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "button-style immersive-btn" }, _attrs))}><img${ssrRenderAttr("src", book_default)} alt="沉浸式阅读">`);
...
var SearchResults_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		return (_ctx, _push, _parent, _attrs) => {
			if (__props.show) {
				_push(`<div${ssrRenderAttrs(mergeProps({ class: "search-results" }, _attrs))} data-v-5646ee07>`);
				if (__props.results.length === 0) _push(`<div class="search-empty" data-v-5646ee07> 搜索: &quot;${ssrInterpolate(unref(escapeHtml)(__props.searchText))}&quot; - 未找到结果 </div>`);
				else {
					_push(`<!--[--><div class="search-counter" data-v-5646ee07>${ssrInterpolate(__props.results.length)} 个结果 </div><!--[-->`);
					ssrRenderList(__props.results, (item) => {
						_push(`<div class="search-result-item" data-v-5646ee07><div class="result-title" data-v-5646ee07>${unref(highlightMatch)(unref(escapeHtml)(item.title), __props.searchText) ?? ""}</div><div class="result-meta" data-v-5646ee07> 分类: <span data-v-5646ee07>${unref(highlightMatch)(unref(escapeHtml)(item.category || ""), __props.searchText) ?? ""}</span> | ID: <span data-v-5646ee07>${unref(highlightMatch)(unref(escapeHtml)(item.id), __props.searchText) ?? ""}</span></div>`);
						if (item.tags && item.tags.length > 0) {
							_push(`<div class="result-tags" data-v-5646ee07><!--[-->`);
							ssrRenderList(item.tags, (tag) => {
								_push(`<span class="tag" data-v-5646ee07>${ssrInterpolate(tag)}</span>`);
							});
							_push(`<!--]--></div>`);
						} else _push(`<!---->`);
						_push(`</div>`);
...
var SearchResults_default = /* @__PURE__ */ _plugin_vue_export_helper_default(SearchResults_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-5646ee07"]]);
//#endregion
...
var Search_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "search-card search-container" }, _attrs))} data-v-ea93c24f><input type="text" placeholder="搜索"${ssrRenderAttr("value", searchText.value)} data-v-ea93c24f>`);
...
var Search_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Search_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-ea93c24f"]]);
//#endregion
...
var MobileMenu_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "mobile-menu-container" }, _attrs))} data-v-e72372eb><div id="mobile-menu-toggle" class="${ssrRenderClass([{ animating: _ctx.isAnimating }, "button-style mobile-menu-toggle"])}" data-v-e72372eb><img${ssrRenderAttr("src", order_default)} alt="菜单" data-v-e72372eb></div><div class="mobile-menu-overlay" id="mobile-menu-overlay" data-v-e72372eb></div></div>`);
		};
	}
});
//#endregion
...
var MobileMenu_default = /* @__PURE__ */ _plugin_vue_export_helper_default(MobileMenu_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-e72372eb"]]);
//#endregion
...
var Header_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		onMounted(() => {});
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(_attrs)} data-v-50185bd9>`);
			_push(ssrRenderComponent(ReadingProgress_default, null, null, _parent));
			_push(`<header class="header-flex" data-v-50185bd9><div class="header-S" data-v-50185bd9><nav class="header-container" data-v-50185bd9><div class="header-card" data-v-50185bd9>`);
			_push(ssrRenderComponent(Logo_default, null, null, _parent));
			_push(ssrRenderComponent(Search_default, null, null, _parent));
			_push(`<div class="button-class-card" data-v-50185bd9>`);
...
var Header_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Header_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-50185bd9"]]);
//#endregion
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
	_push(`<div${ssrRenderAttrs(mergeProps({ class: "avator-card" }, _attrs))} data-v-c6c037d1><img${ssrRenderAttr("src", avator_default)} alt="Cnkrru的头像" data-v-c6c037d1></div>`);
}
...
var Avatar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-c6c037d1"]]);
//#endregion
...
var Sidebar_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<aside${ssrRenderAttrs(mergeProps({ class: "left-asider-S" }, _attrs))} data-v-13bb49f5><div class="left-asider-container" data-v-13bb49f5><div class="left-asider-card" data-v-13bb49f5>`);
...
var Sidebar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Sidebar_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-13bb49f5"]]);
//#endregion
...
var Center_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<section${ssrRenderAttrs(mergeProps({ class: "center-S" }, _attrs))} data-v-eb968064><div class="center-container" data-v-eb968064><div class="center-card" data-v-eb968064><div class="center-header-area" data-v-eb968064>`);
...
var Center_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Center_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-eb968064"]]);
//#endregion
...
var Footer_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer-flex" }, _attrs))} data-v-c801d66f><div class="footer-S" data-v-c801d66f><nav class="footer-container" data-v-c801d66f><div class="footer-card" data-v-c801d66f>`);
...
var Footer_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Footer_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-c801d66f"]]);
//#endregion
			...
			ssrRenderTeleport(_push, (_push) => {
				if (visible.value) {
					_push(`<div class="anime-context-menu" style="${ssrRenderStyle({
						left: `${x.value}px`,
						top: `${y.value}px`
					})}" data-v-6bf4b08e><div class="menu-header" data-v-6bf4b08e><span class="menu-avatar" data-v-6bf4b08e>ฅ^•ﻌ•^ฅ</span><span class="menu-title" data-v-6bf4b08e>菜单</span></div><div class="menu-divider" data-v-6bf4b08e></div><!--[-->`);
					ssrRenderList(menuItems, (item, index) => {
						_push(`<div class="menu-item" data-v-6bf4b08e><span class="menu-icon" data-v-6bf4b08e>${ssrInterpolate(item.icon)}</span><span class="menu-label" data-v-6bf4b08e>${ssrInterpolate(item.label)}</span></div>`);
					});
					_push(`<!--]--></div>`);
				} else _push(`<!---->`);
			}, "body", false, _parent);
...
var ContextMenu_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ContextMenu_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-6bf4b08e"]]);
//#endregion
...
var routes = [
	...
	},
	{
		path: "/home",
		name: "Home",
		component: () => import("./assets/Home-CXaHDgai.js")
	},
	{
		path: "/about",
		name: "About",
		component: () => import("./assets/About-CmuqWzes.js")
	},
	{
		path: "/archives",
		name: "Archives",
		component: () => import("./assets/Archives-BGah9h2M.js")
	},
	{
		path: "/links",
		name: "Links",
	...
	},
	{
		path: "/post/:id",
		name: "Post",
		component: () => import("./assets/Posts-Be7bS6ak.js")
	},
	{
		path: "/project/:id",
		name: "Project",
		component: () => import("./assets/Projects-XAHze7cp.js")
	},
	{
		path: "/timeline",
		name: "Timeline",
		component: () => import("./assets/Timeline-DvX7eD8B.js")
	},
	{
		path: "/search",
		name: "Search",
	...
	},
	{
		path: "/changelog",
		name: "Changelog",
		component: () => import("./assets/Changelog-zdjKDTo8.js")
	},
	{
		path: "/:pathMatch(.*)*",
		name: "NotFound",
