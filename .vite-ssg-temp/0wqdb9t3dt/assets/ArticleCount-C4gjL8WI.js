...
var ArticleCount_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<button${ssrRenderAttrs(mergeProps({ class: "article-count-btn" }, _attrs))} data-v-7d1a93c8><span data-v-7d1a93c8>共 ${ssrInterpolate(articleCount.value)} 篇文章</span></button>`);
		};
	}
});
//#endregion
...
var ArticleCount_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ArticleCount_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-7d1a93c8"]]);
//#endregion
