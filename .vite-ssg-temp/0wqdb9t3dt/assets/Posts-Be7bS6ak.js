...
import { a as ReadingTime_default, i as Toc_default, n as PostMenu_default, o as ContentRender_default, r as TocButton_default, s as BackToTop_default, t as Comment_default } from "./Comment-CFyYQHMV.js";
import { n as ArticleNav_default, t as SiteStats_default } from "./SiteStats-_q0ASZAe.js";
...
var RelatedArticles_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "related-articles-wrapper" }, _attrs))} data-v-cdaf9429><div class="${ssrRenderClass([{ "dark-theme": isDarkTheme.value }, "related-articles-container"])}" data-v-cdaf9429><h3 class="related-articles-title" data-v-cdaf9429>相关文章推荐</h3><div class="related-articles-list" data-v-cdaf9429><!--[-->`);
			ssrRenderList(relatedArticles.value, (article) => {
				_push(`<div class="related-article-item" data-v-cdaf9429>`);
				_push(ssrRenderComponent(unref(RouterLink), {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) {
							_push(`<div class="related-article-content" data-v-cdaf9429${_scopeId}>`);
							if (article.category) _push(`<span class="related-article-category" data-v-cdaf9429${_scopeId}>${ssrInterpolate(article.category)}</span>`);
							else _push(`<!---->`);
							_push(`<div class="related-article-title" data-v-cdaf9429${_scopeId}>${ssrInterpolate(article.title)}</div><div class="related-article-meta" data-v-cdaf9429${_scopeId}><span class="related-article-date" data-v-cdaf9429${_scopeId}>${ssrInterpolate(article.date)}</span>`);
							if (article.tags && article.tags.length > 0) {
								_push(`<span class="related-article-tags" data-v-cdaf9429${_scopeId}><!--[-->`);
								ssrRenderList(article.tags.slice(0, 2), (tag) => {
									_push(`<span class="tag" data-v-cdaf9429${_scopeId}>${ssrInterpolate(tag)}</span>`);
								});
								_push(`<!--]--></span>`);
							} else _push(`<!---->`);
							_push(`</div></div><span class="related-article-arrow" data-v-cdaf9429${_scopeId}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-cdaf9429${_scopeId}><polyline points="9 18 15 12 9 6" data-v-cdaf9429${_scopeId}></polyline></svg></span>`);
...
var RelatedArticles_default = /* @__PURE__ */ _plugin_vue_export_helper_default(RelatedArticles_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-cdaf9429"]]);
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (sponsor.value.enabled) {
				_push(`<div${ssrRenderAttrs(mergeProps({ class: "sponsor-wrap" }, _attrs))} data-v-70a639e4><button class="sponsor-btn" title="赞赏" data-v-70a639e4><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-70a639e4><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" data-v-70a639e4></path></svg> 赞赏 </button>`);
				ssrRenderTeleport(_push, (_push) => {
					if (showModal.value) _push(`<div class="sponsor-overlay" data-v-70a639e4><div class="sponsor-modal" data-v-70a639e4><div class="sponsor-header" data-v-70a639e4><h3 data-v-70a639e4>赞赏支持</h3><button class="sponsor-close" data-v-70a639e4>×</button></div><p class="sponsor-msg" data-v-70a639e4>${ssrInterpolate(sponsor.value.message)}</p><div class="sponsor-tabs" data-v-70a639e4><button class="${ssrRenderClass(["sp-tab", { active: activeTab.value === "wechat" }])}" data-v-70a639e4>微信</button><button class="${ssrRenderClass(["sp-tab", { active: activeTab.value === "alipay" }])}" data-v-70a639e4>支付宝</button></div><div class="sponsor-qr" data-v-70a639e4><img${ssrRenderAttr("src", activeTab.value === "wechat" ? sponsor.value.wechat : sponsor.value.alipay)}${ssrRenderAttr("alt", activeTab.value === "wechat" ? "微信赞赏码" : "支付宝收款码")} class="qr-image" data-v-70a639e4></div><p class="sponsor-thanks" data-v-70a639e4>感谢你的支持 ✨</p></div></div>`);
					else _push(`<!---->`);
				}, "body", false, _parent);
				_push(`</div>`);
			} else _push(`<!---->`);
...
var Sponsor_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Sponsor_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-70a639e4"]]);
//#endregion
