...
var ReadingTime_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "reading-time-wrapper" }, _attrs))} data-v-20a975c8>`);
			if (readingTime.value) _push(`<div class="${ssrRenderClass([{ "dark-theme": isDarkTheme.value }, "reading-time-container"])}" data-v-20a975c8><div class="word-count-section" data-v-20a975c8><span class="word-count-icon" data-v-20a975c8><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-20a975c8><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" data-v-20a975c8></path><polyline points="14 2 14 8 20 8" data-v-20a975c8></polyline><line x1="16" y1="13" x2="8" y2="13" data-v-20a975c8></line><line x1="16" y1="17" x2="8" y2="17" data-v-20a975c8></line><polyline points="10 9 9 9 8 9" data-v-20a975c8></polyline></svg></span><span class="word-count-text" data-v-20a975c8> 字数统计: ${ssrInterpolate(readingTime.value.totalWords)} 字 </span><span class="word-count-detail" data-v-20a975c8> (${ssrInterpolate(readingTime.value.chineseCount)}中文 / ${ssrInterpolate(readingTime.value.englishCount)}英文 / ${ssrInterpolate(readingTime.value.codeCount)}代码) </span></div><div class="reading-time-section" data-v-20a975c8><span class="reading-time-icon" data-v-20a975c8><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-20a975c8><circle cx="12" cy="12" r="10" data-v-20a975c8></circle><polyline points="12 6 12 12 16 14" data-v-20a975c8></polyline></svg></span><span class="reading-time-text" data-v-20a975c8> 预计阅读时间: ${ssrInterpolate(formatTime(readingTime.value))}</span></div></div>`);
			else _push(`<!---->`);
			_push(`</div>`);
		};
	}
...
var ReadingTime_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ReadingTime_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-20a975c8"]]);
//#endregion
...
var Toc_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: ["toc-card", { active: __props.show }] }, _attrs))} data-v-f419fbd2><div class="toc-card-header" data-v-f419fbd2><h3 data-v-f419fbd2>文章目录</h3><div class="header-actions" data-v-f419fbd2>`);
			if (toc.value.length) _push(`<span class="toc-count" data-v-f419fbd2>${ssrInterpolate(toc.value.length)} 项</span>`);
			else _push(`<!---->`);
			_push(`<button class="toc-close-btn" title="关闭" data-v-f419fbd2>x</button></div></div><div class="toc-toolbar" data-v-f419fbd2>`);
			if (expandedAll.value) _push(`<button class="toc-tb-btn" data-v-f419fbd2>折叠全部</button>`);
			else _push(`<button class="toc-tb-btn" data-v-f419fbd2>展开全部</button>`);
			_push(`</div><div class="toc-card-content" data-v-f419fbd2><ul class="toc-list" data-v-f419fbd2><!--[-->`);
			ssrRenderList(renderedTree.value, (node) => {
				_push(`<li class="${ssrRenderClass([[`lv-${node.level}`, { active: node.active }], "toc-item"])}" data-v-f419fbd2><a href="#" class="toc-link" data-v-f419fbd2>`);
				if (node.hasChildren) _push(`<span class="toc-arrow" data-v-f419fbd2><svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" class="${ssrRenderClass({ rot: !node.collapsed })}" data-v-f419fbd2><polygon points="8,4 16,12 8,20" data-v-f419fbd2></polygon></svg></span>`);
				else _push(`<span class="toc-arrow-blank" data-v-f419fbd2></span>`);
				_push(`<span class="toc-num" data-v-f419fbd2>${ssrInterpolate(node.numbering)}</span><span class="toc-text" data-v-f419fbd2>${ssrInterpolate(node.text)}</span></a>`);
				if (node.hasChildren && !node.collapsed) {
					_push(`<div class="toc-children" data-v-f419fbd2><ul class="toc-list" data-v-f419fbd2><!--[-->`);
					ssrRenderList(node.childrenHtml, (child) => {
						_push(`<li class="${ssrRenderClass([[`lv-${child.level}`, { active: child.active }], "toc-item"])}" data-v-f419fbd2><a href="#" class="toc-link" data-v-f419fbd2>`);
						if (child.hasChildren) _push(`<span class="toc-arrow" data-v-f419fbd2><svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" class="${ssrRenderClass({ rot: !child.collapsed })}" data-v-f419fbd2><polygon points="8,4 16,12 8,20" data-v-f419fbd2></polygon></svg></span>`);
						else _push(`<span class="toc-arrow-blank" data-v-f419fbd2></span>`);
						_push(`<span class="toc-num" data-v-f419fbd2>${ssrInterpolate(child.numbering)}</span><span class="toc-text" data-v-f419fbd2>${ssrInterpolate(child.text)}</span></a>`);
						if (child.hasChildren && !child.collapsed) {
							_push(`<div class="toc-children" data-v-f419fbd2><ul class="toc-list" data-v-f419fbd2><!--[-->`);
							ssrRenderList(child.childrenHtml, (gc) => {
								_push(`<li class="${ssrRenderClass([[`lv-${gc.level}`, { active: gc.active }], "toc-item"])}" data-v-f419fbd2><a href="#" class="toc-link" data-v-f419fbd2><span class="toc-arrow-blank" data-v-f419fbd2></span><span class="toc-num" data-v-f419fbd2>${ssrInterpolate(gc.numbering)}</span><span class="toc-text" data-v-f419fbd2>${ssrInterpolate(gc.text)}</span></a></li>`);
							});
							_push(`<!--]--></ul></div>`);
						} else _push(`<!---->`);
						_push(`</li>`);
			...
			_push(`<!--]--></ul>`);
			if (!toc.value.length) _push(`<div class="toc-empty" data-v-f419fbd2>暂无目录</div>`);
			else _push(`<!---->`);
			_push(`</div></div>`);
		};
	}
...
var Toc_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Toc_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-f419fbd2"]]);
//#endregion
