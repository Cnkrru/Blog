...
var HighlightRender_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: ["code-container", { "with-line-numbers": showLineNumbers.value }] }, _attrs))} data-v-85132a4d>`);
			if (__props.language && unref(codeStore).showLanguageBadge) {
				_push(`<div class="code-header" data-v-85132a4d><span class="language-badge"${ssrRenderAttr("data-lang", __props.language.toLowerCase())} data-v-85132a4d><span class="lang-dot" data-v-85132a4d></span><span class="lang-text" data-v-85132a4d>${ssrInterpolate(__props.language)}</span></span><div class="header-actions" data-v-85132a4d>`);
				if (showCopyButton.value) _push(ssrRenderComponent(CodeRender_default, { code: __props.code }, null, _parent));
				else _push(`<!---->`);
				if (showLineNumbers.value) _push(`<span class="line-count" data-v-85132a4d>${ssrInterpolate(__props.code.split("\n").length)} lines</span>`);
				else _push(`<!---->`);
				_push(`</div></div>`);
			} else _push(`<!---->`);
			_push(`<div class="${ssrRenderClass([{ "loading": !isLoaded.value }, "code-content-wrapper"])}" data-v-85132a4d>`);
			if (showLineNumbers.value) {
				_push(`<div class="line-numbers" data-v-85132a4d><!--[-->`);
				ssrRenderList(generateLineNumbers(), (line) => {
					_push(`<span class="line-number" data-v-85132a4d>${ssrInterpolate(line)}</span>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			_push(`<pre class="code-content" data-v-85132a4d>        <code class="${ssrRenderClass(`language-${__props.language}`)}" data-v-85132a4d>${ssrInterpolate(__props.code)}</code>
      </pre>`);
			if (showLineNumbers.value) {
				_push(`<div class="line-highlight-overlay" data-v-85132a4d><!--[-->`);
				ssrRenderList(generateLineNumbers(), (_, i) => {
					_push(`<div class="line-highlight-row" data-v-85132a4d></div>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			if (!isLoaded.value) _push(`<div class="loading-overlay" data-v-85132a4d><div class="loading-spinner" data-v-85132a4d></div><span class="loading-text" data-v-85132a4d>Loading syntax highlighting...</span></div>`);
			else _push(`<!---->`);
			_push(`</div></div>`);
		};
	}
...
var HighlightRender_default = /* @__PURE__ */ _plugin_vue_export_helper_default(HighlightRender_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-85132a4d"]]);
//#endregion
