...
//#region src/pages/project/Projects.vue?vue&type=script&setup=true&lang.ts
var Projects_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<!--[--><div id="site-stats-container" data-v-359d0137></div><div class="center-head-card" data-v-359d0137><h2 data-v-359d0137>${ssrInterpolate(project.value?.name || "项目详情")}</h2><div class="center-head-card-tools" data-v-359d0137>`);
			...
			_push(`<hr data-v-359d0137><div class="center-card-content" data-v-359d0137>`);
			...
			if (!loading.value && !error.value) _push(`<hr data-v-359d0137>`);
			else _push(`<!---->`);
			...
			if (!loading.value && !error.value) _push(`<div class="read-center-card-footer" data-v-359d0137><p data-v-359d0137>© 2026 Cnkrru&#39;s Blog. All rights reserved.</p></div>`);
			else _push(`<!---->`);
...
var Projects_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Projects_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-359d0137"]]);
//#endregion
