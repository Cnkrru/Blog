...
import { createVNode, defineComponent, onMounted, ref, resolveComponent, toDisplayString, useSSRContext, withCtx } from "vue";
...
var Projects_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<!--[--><div id="site-stats-container" data-v-5bf4d751></div><div class="center-head-card" data-v-5bf4d751><h2 data-v-5bf4d751>项目</h2></div><hr data-v-5bf4d751><div class="center-card-content" data-v-5bf4d751>`);
			if (getCurrentCategory()) {
				_push(`<div class="projects-content" data-v-5bf4d751><!--[-->`);
				ssrRenderList(getCurrentCategory().projects, (project) => {
					_push(ssrRenderComponent(_component_RouterLink, {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<div class="project-name" data-v-5bf4d751${_scopeId}>${ssrInterpolate(project.name)}</div><div class="project-description" data-v-5bf4d751${_scopeId}>${ssrInterpolate(project.description)}</div>`);
...
var Projects_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Projects_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-5bf4d751"]]);
//#endregion
