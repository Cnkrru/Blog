...
var Center_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<section${ssrRenderAttrs(mergeProps({ class: "center-S" }, _attrs))} data-v-a2f5613a><div class="center-container" data-v-a2f5613a><div class="center-card" data-v-a2f5613a><div class="center-header-area" data-v-a2f5613a>`);
...
var Center_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Center_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-a2f5613a"]]);
//#endregion
