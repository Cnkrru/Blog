...
//#region src/pages/Changelog.vue?vue&type=script&setup=true&lang.ts
var Changelog_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<!--[--><div id="site-stats-container" data-v-4c169ede></div><div class="center-head-card" data-v-4c169ede><h2 data-v-4c169ede>${ssrInterpolate(post.value?.title || "网站更新日志")}</h2><div class="center-head-card-tools" data-v-4c169ede>`);
			...
			_push(`<hr data-v-4c169ede><div class="center-card-content" data-v-4c169ede>`);
			...
			if (!loading.value && !error.value) _push(`<hr data-v-4c169ede>`);
			else _push(`<!---->`);
			if (!loading.value && !error.value) _push(ssrRenderComponent(_component_Share, null, null, _parent));
			else _push(`<!---->`);
			if (!loading.value && !error.value) _push(`<hr data-v-4c169ede>`);
			else _push(`<!---->`);
			if (!loading.value && !error.value) _push(`<div class="read-center-card-footer" data-v-4c169ede><p data-v-4c169ede>© 2026 Cnkrru&#39;s Blog. All rights reserved.</p></div>`);
			else _push(`<!---->`);
			if (!loading.value && !error.value) _push(ssrRenderComponent(Comment_default, null, null, _parent));
			else _push(`<!---->`);
			_push(`</div><hr data-v-4c169ede><!--]-->`);
		};
	}
});
//#endregion
//#region src/pages/Changelog.vue
...
Changelog_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/Changelog.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var Changelog_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Changelog_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-4c169ede"]]);
//#endregion
