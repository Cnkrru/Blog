...
import { computed, onMounted, ref, resolveComponent, useSSRContext } from "vue";
...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<!--[--><div id="site-stats-container" data-v-8a00ffff></div><div class="center-head-card" data-v-8a00ffff><h2 data-v-8a00ffff>${ssrInterpolate(post.value?.title || "网站更新日志")}</h2><div class="center-head-card-tools" data-v-8a00ffff>`);
			...
			_push(`<hr data-v-8a00ffff><div class="center-card-content" data-v-8a00ffff>`);
			...
			if (!loading.value && !error.value) _push(`<hr data-v-8a00ffff>`);
			else _push(`<!---->`);
			if (!loading.value && !error.value) _push(ssrRenderComponent(_component_Share, null, null, _parent));
			else _push(`<!---->`);
			if (!loading.value && !error.value) _push(`<hr data-v-8a00ffff>`);
			else _push(`<!---->`);
			if (!loading.value && !error.value) _push(`<div class="read-center-card-footer" data-v-8a00ffff><p data-v-8a00ffff>© 2026 Cnkrru&#39;s Blog. All rights reserved.</p></div>`);
			else _push(`<!---->`);
			if (!loading.value && !error.value) _push(ssrRenderComponent(Comment_default, null, null, _parent));
			else _push(`<!---->`);
			_push(`</div><hr data-v-8a00ffff><!--]-->`);
		};
	}
};
...
var Changelog_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-8a00ffff"]]);
//#endregion
