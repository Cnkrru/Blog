...
import { computed, createApp as createApp$1, createBlock, createTextVNode, createVNode, defineComponent, mergeProps, nextTick, onMounted, onUnmounted, openBlock, ref, resolveComponent, toDisplayString, unref, useSSRContext, watch, withCtx } from "vue";
...
import { RouterLink, createMemoryHistory, createRouter, useRoute, useRouter } from "vue-router";
...
var _sfc_setup$34 = Logo_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$33 = ThemeToggle_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$32 = ImmersiveReading_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$31 = ReadingProgress_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$30 = SearchResults_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$29 = Search_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$28 = PlayerControls_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$27 = PlayerProgress_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$26 = PlayerVolume_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$25 = PlayerPlaylist_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$24 = AudioVisualizer_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$23 = AudioEffects_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$22 = _sfc_main$2.setup;
...
var _sfc_setup$21 = MusicPlay_vue_vue_type_script_setup_true_lang_default.setup;
...
var MobileMenu_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "mobile-menu-container" }, _attrs))} data-v-60b2d709><div id="mobile-menu-toggle" class="${ssrRenderClass([{ animating: isAnimating.value }, "button-style mobile-menu-toggle"])}" data-v-60b2d709><img${ssrRenderAttr("src", order_default)} alt="菜单" data-v-60b2d709>`);
			if (isAnimating.value) _push(`<span class="emoji-burst" data-v-60b2d709>✨</span>`);
			else _push(`<!---->`);
			_push(`</div><div class="mobile-menu-overlay" id="mobile-menu-overlay" data-v-60b2d709></div></div>`);
		};
	}
});
//#endregion
//#region src/components/p-header/MobileMenu.vue
var _sfc_setup$20 = MobileMenu_vue_vue_type_script_setup_true_lang_default.setup;
...
var MobileMenu_default = /* @__PURE__ */ _plugin_vue_export_helper_default(MobileMenu_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-60b2d709"]]);
//#endregion
...
var _sfc_setup$19 = DynamicEffectControl_vue_vue_type_script_setup_true_lang_default.setup;
...
var Header_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		onMounted(() => {});
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(_attrs)} data-v-7f704400>`);
			_push(ssrRenderComponent(ReadingProgress_default, null, null, _parent));
			_push(`<header class="header-flex" data-v-7f704400><div class="header-S" data-v-7f704400><nav class="header-container" data-v-7f704400><div class="header-card" data-v-7f704400>`);
			_push(ssrRenderComponent(Logo_default, null, null, _parent));
			_push(ssrRenderComponent(Search_default, null, null, _parent));
			_push(`<div class="button-class-card" data-v-7f704400>`);
...
var _sfc_setup$18 = Header_vue_vue_type_script_setup_true_lang_default.setup;
...
var Header_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Header_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-7f704400"]]);
//#endregion
...
var _sfc_setup$17 = _sfc_main$1.setup;
...
var _sfc_setup$16 = WelcomeSaying_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$14 = Weather_vue_vue_type_script_setup_true_lang_default.setup;
...
var Sidebar_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<aside${ssrRenderAttrs(mergeProps({ class: "left-asider-S" }, _attrs))} data-v-bb932a5e><div class="left-asider-container" data-v-bb932a5e><div class="left-asider-card" data-v-bb932a5e>`);
...
var Sidebar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Sidebar_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-bb932a5e"]]);
//#endregion
...
var Center_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<section${ssrRenderAttrs(mergeProps({ class: "center-S" }, _attrs))} data-v-0b4da965><div class="center-container" data-v-0b4da965><div class="center-card" data-v-0b4da965><div class="center-header-area" data-v-0b4da965>`);
...
var _sfc_setup$12 = Center_vue_vue_type_script_setup_true_lang_default.setup;
...
var Center_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Center_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-0b4da965"]]);
//#endregion
...
var _sfc_setup$11 = WebsiteAge_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$10 = CopyRight_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$9 = Footer_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$8 = WebAnalytics_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$7 = Live2dWidget_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$6 = NotificationRender_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$5 = MouseTrail_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$4 = ConsoleEasterEgg_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$3 = ContextMenu_vue_vue_type_script_setup_true_lang_default.setup;
...
var _sfc_setup$2 = ScrollEasterEgg_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region src/components/MobileNav.vue?vue&type=script&setup=true&lang.ts
var MobileNav_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<nav${ssrRenderAttrs(mergeProps({ class: "mobile-nav" }, _attrs))} data-v-fd49cc77><!--[-->`);
			ssrRenderList(items, (item) => {
				_push(ssrRenderComponent(unref(RouterLink), {
					key: item.path,
					to: item.path,
					class: ["mn-item", { active: currentPath.value === item.path }]
				}, {
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`<span class="mn-icon" data-v-fd49cc77${_scopeId}>${ssrInterpolate(item.icon)}</span><span class="mn-label" data-v-fd49cc77${_scopeId}>${ssrInterpolate(item.label)}</span>`);
						else return [createVNode("span", { class: "mn-icon" }, toDisplayString(item.icon), 1), createVNode("span", { class: "mn-label" }, toDisplayString(item.label), 1)];
					}),
					_: 2
				}, _parent));
			});
...
//#endregion
//#region src/components/MobileNav.vue
...
MobileNav_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/MobileNav.vue");
	return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
var MobileNav_default = /* @__PURE__ */ _plugin_vue_export_helper_default(MobileNav_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-fd49cc77"]]);
//#endregion
...
var App_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${ssrRenderAttrs(mergeProps({ id: "app" }, _attrs))} data-v-7db0a247>`);
			if (progressVisible.value) _push(`<div class="page-progress-bar" data-v-7db0a247><div class="page-progress-fill" style="${ssrRenderStyle({ width: progressWidth.value })}" data-v-7db0a247></div></div>`);
			else _push(`<!---->`);
			...
			if (!isIndexPage.value && !isTerminalPage.value) {
				...
				_push(`<main class="mid-flex" data-v-7db0a247>`);
				...
				if (!isIndexPage.value && !isTerminalPage.value) _push(ssrRenderComponent(MobileNav_default, null, null, _parent));
				else _push(`<!---->`);
				_push(`<!--]-->`);
...
var App_default = /* @__PURE__ */ _plugin_vue_export_helper_default(App_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-7db0a247"]]);
//#endregion
