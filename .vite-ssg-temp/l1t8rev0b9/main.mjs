...
var App_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${ssrRenderAttrs(mergeProps({ id: "app" }, _attrs))} data-v-e78557fe>`);
			if (progressVisible.value) _push(`<div class="page-progress-bar" data-v-e78557fe><div class="page-progress-fill" style="${ssrRenderStyle({ width: progressWidth.value })}" data-v-e78557fe></div></div>`);
			else _push(`<!---->`);
			...
			if (!isIndexPage.value && !isTerminalPage.value) {
				...
				_push(`<main class="mid-flex" data-v-e78557fe>`);
...
var App_default = /* @__PURE__ */ _plugin_vue_export_helper_default(App_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-e78557fe"]]);
//#endregion
