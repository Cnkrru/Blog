...
var SearchPage_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[--><div class="center-head-card" data-v-3895f3a4><h2 data-v-3895f3a4>搜索</h2></div><hr data-v-3895f3a4><div class="center-card-content" data-v-3895f3a4><div class="search-input-wrap" data-v-3895f3a4><input${ssrRenderAttr("value", query.value)} type="search" placeholder="搜索文章标题、描述、标签..." class="search-field" autofocus data-v-3895f3a4>`);
			if (query.value) _push(`<span class="result-count" data-v-3895f3a4>${ssrInterpolate(results.value.length)} 个结果</span>`);
			else _push(`<!---->`);
			_push(`</div>`);
			if (loading.value) _push(`<div class="search-loading" data-v-3895f3a4>加载中...</div>`);
				...
				ssrRenderList(results.value, (a) => {
					_push(ssrRenderComponent(unref(RouterLink), {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								_push(`<h3 class="sr-title" data-v-3895f3a4${_scopeId}>${highlightMatch(a.title) ?? ""}</h3>`);
								if (a.description) _push(`<p class="sr-desc" data-v-3895f3a4${_scopeId}>${highlightMatch(a.description.slice(0, 120)) ?? ""}</p>`);
								else _push(`<!---->`);
								_push(`<div class="sr-meta" data-v-3895f3a4${_scopeId}>`);
								if (a.category) _push(`<span class="sr-cat" data-v-3895f3a4${_scopeId}>${ssrInterpolate(a.category)}</span>`);
								else _push(`<!---->`);
								_push(`<!--[-->`);
								ssrRenderList((a.tags || []).slice(0, 3), (t) => {
									_push(`<span class="sr-tag" data-v-3895f3a4${_scopeId}>${ssrInterpolate(t)}</span>`);
								});
								_push(`<!--]--><span class="sr-date" data-v-3895f3a4${_scopeId}>${ssrInterpolate(a.date)}</span></div>`);
							} else return [
								createVNode("h3", {
									class: "sr-title",
				...
				_push(`<!--]-->`);
			} else if (query.value) _push(`<div class="search-empty" data-v-3895f3a4> 没有找到匹配的文章 </div>`);
			else _push(`<div class="search-hint" data-v-3895f3a4> 输入关键词开始搜索 </div>`);
			_push(`</div><!--]-->`);
		};
	}
});
...
var SearchPage_default = /* @__PURE__ */ _plugin_vue_export_helper_default(SearchPage_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-3895f3a4"]]);
//#endregion
