import { _ as useThemeStore, d as useDynamicEffectsStore, f as useMouseStore, i as useArticlesStore, o as useGlobalStore, p as useNotificationStore, r as useMusicStore, t as pinia } from "./assets/stores-D945GC2p.js";
...
var BusuanziStats_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const fetchBusuanzi = () => {
			...
			window[callbackName] = (data) => {
				...
				if (data && typeof data === "object") {
					if (data.site_pv !== void 0) stats.value.sitePv = String(data.site_pv);
					if (data.site_uv !== void 0) stats.value.siteUv = String(data.site_uv);
					if (data.page_pv !== void 0) stats.value.pagePv = String(data.page_pv);
				}
				loading.value = false;
				error.value = false;
			};
		...
		const cleanup = () => {
			...
			if (jsonpScript && jsonpScript.parentElement) jsonpScript.parentElement.removeChild(jsonpScript);
			jsonpScript = null;
			if (timeoutId) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "busuanzi-wrapper" }, _attrs))} data-v-44d81b63><button class="busuanzi-btn" title="站点统计" data-v-44d81b63> 统计 </button>`);
			ssrRenderTeleport(_push, (_push) => {
				if (showPopup.value) {
					_push(`<div class="busuanzi-overlay" data-v-44d81b63><div class="busuanzi-popup" data-v-44d81b63><div class="popup-header" data-v-44d81b63><h3 data-v-44d81b63>站点统计</h3><button class="popup-close" data-v-44d81b63>×</button></div>`);
					if (loading.value) _push(`<div class="popup-loading" data-v-44d81b63><div class="loading-spinner" data-v-44d81b63></div><span data-v-44d81b63>加载中...</span></div>`);
					else if (error.value) _push(`<div class="popup-error" data-v-44d81b63><span data-v-44d81b63>统计数据加载失败</span><button class="retry-btn" data-v-44d81b63>重试</button></div>`);
					else _push(`<div class="stats-grid" data-v-44d81b63><div class="stats-item" data-v-44d81b63><span class="stats-label" data-v-44d81b63>站点 PV</span><span class="stats-value" data-v-44d81b63>${ssrInterpolate(stats.value.sitePv)}</span></div><div class="stats-item" data-v-44d81b63><span class="stats-label" data-v-44d81b63>站点 UV</span><span class="stats-value" data-v-44d81b63>${ssrInterpolate(stats.value.siteUv)}</span></div><div class="stats-item" data-v-44d81b63><span class="stats-label" data-v-44d81b63>本页阅读</span><span class="stats-value" data-v-44d81b63>${ssrInterpolate(stats.value.pagePv)}</span></div></div>`);
					_push(`<div class="popup-footer" data-v-44d81b63> Powered by <a href="https://busuanzi.ibruce.info" target="_blank" rel="noopener" data-v-44d81b63>不蒜子</a></div></div></div>`);
				} else _push(`<!---->`);
			}, "body", false, _parent);
			_push(`</div>`);
		};
...
var BusuanziStats_default = /* @__PURE__ */ _plugin_vue_export_helper_default(BusuanziStats_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-44d81b63"]]);
//#endregion
...
var routes = [
	{
		path: "/",
		name: "Index",
		component: () => import("./assets/pages-CKhz5p58.js")
	},
	{
		path: "/home",
		name: "Home",
		component: () => import("./assets/Home-CX0lX2lC.js")
	},
	{
		path: "/about",
		name: "About",
		component: () => import("./assets/About-BMQ180_v.js")
	},
	{
		path: "/archives",
		name: "Archives",
		component: () => import("./assets/Archives-Cuz0Q_vG.js")
	},
	{
		path: "/links",
		name: "Links",
	...
	},
	{
		path: "/post/:id",
		name: "Post",
		component: () => import("./assets/Post-DGUAlOro.js")
	},
	{
		path: "/project/:id",
		name: "Project",
		component: () => import("./assets/ProjectDetail-BBLIcT9g.js")
	},
	{
		path: "/timeline",
		name: "Timeline",
		component: () => import("./assets/Timeline-Da_snvHz.js")
	},
	{
		path: "/search",
		name: "Search",
		component: () => import("./assets/SearchPage-DLGlr4Ec.js")
	},
	{
		path: "/links/apply",
		name: "LinkApply",
	...
	},
	{
		path: "/settings",
		name: "Settings",
		component: () => import("./assets/Settings-CsnIjfig.js")
	},
	{
		path: "/changelog",
		name: "Changelog",
		component: () => import("./assets/Changelog-BO-T96gc.js")
	},
	{
		path: "/:pathMatch(.*)*",
		name: "NotFound",
