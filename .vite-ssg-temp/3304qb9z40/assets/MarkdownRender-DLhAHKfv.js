...
var HighlightRender_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: ["code-container", { "with-line-numbers": showLineNumbers.value }] }, _attrs))} data-v-ee9a7349>`);
			if (__props.language && unref(codeStore).showLanguageBadge) {
				_push(`<div class="code-header" data-v-ee9a7349><span class="language-badge"${ssrRenderAttr("data-lang", __props.language.toLowerCase())} data-v-ee9a7349><span class="lang-dot" data-v-ee9a7349></span><span class="lang-text" data-v-ee9a7349>${ssrInterpolate(__props.language)}</span></span><div class="header-actions" data-v-ee9a7349>`);
				...
				if (showLineNumbers.value) _push(`<span class="line-count" data-v-ee9a7349>${ssrInterpolate(__props.code.split("\n").length)} lines</span>`);
				else _push(`<!---->`);
				_push(`</div></div>`);
			} else _push(`<!---->`);
			_push(`<div class="${ssrRenderClass([{ "loading": !isLoaded.value }, "code-content-wrapper"])}" data-v-ee9a7349>`);
			if (showLineNumbers.value) {
				_push(`<div class="line-numbers" data-v-ee9a7349><!--[-->`);
				ssrRenderList(generateLineNumbers(), (line) => {
					_push(`<span class="line-number" data-v-ee9a7349>${ssrInterpolate(line)}</span>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			_push(`<pre class="code-content" data-v-ee9a7349><code class="${ssrRenderClass(`language-${__props.language}`)}" data-v-ee9a7349>${ssrInterpolate(__props.code)}</code></pre>`);
			if (showLineNumbers.value) {
				_push(`<div class="line-highlight-overlay" data-v-ee9a7349><!--[-->`);
				ssrRenderList(generateLineNumbers(), (_, i) => {
					_push(`<div class="line-highlight-row" data-v-ee9a7349></div>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			if (!isLoaded.value) _push(`<div class="loading-overlay" data-v-ee9a7349><div class="loading-spinner" data-v-ee9a7349></div><span class="loading-text" data-v-ee9a7349>Loading syntax highlighting...</span></div>`);
			else _push(`<!---->`);
			_push(`</div></div>`);
		};
	}
...
var HighlightRender_default = /* @__PURE__ */ _plugin_vue_export_helper_default(HighlightRender_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-ee9a7349"]]);
//#endregion
