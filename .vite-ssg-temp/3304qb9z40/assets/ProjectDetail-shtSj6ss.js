...
import { a as ReadingTime_default, i as Toc_default, n as PostMenu_default, o as ContentRender_default, r as TocButton_default, s as BackToTop_default, t as Comment_default } from "./Comment-CaeVc_7t.js";
import { t as ArticleNav_default } from "./ArticleNav-CNa1_SKS.js";
import { computed, defineComponent, ref, resolveComponent, useSSRContext } from "vue";
import { useHead } from "@vueuse/head";
import { ssrInterpolate, ssrRenderComponent } from "vue/server-renderer";
import { useRoute } from "vue-router";
//#region src/pages/ProjectDetail.vue?vue&type=script&setup=true&lang.ts
var ProjectDetail_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<!--[--><div id="site-stats-container" data-v-fcb57cc6></div><div class="center-head-card" data-v-fcb57cc6><h2 data-v-fcb57cc6>${ssrInterpolate(project.value?.name || "项目详情")}</h2><div class="center-head-card-tools" data-v-fcb57cc6>`);
			...
			_push(`<hr data-v-fcb57cc6><div class="center-card-content" data-v-fcb57cc6>`);
			...
			if (!loading.value && !error.value) _push(`<hr data-v-fcb57cc6>`);
			else _push(`<!---->`);
			...
			if (!loading.value && !error.value) _push(`<div class="read-center-card-footer" data-v-fcb57cc6><p data-v-fcb57cc6>© 2026 Cnkrru&#39;s Blog. All rights reserved.</p></div>`);
			else _push(`<!---->`);
			if (!loading.value && !error.value) _push(ssrRenderComponent(Comment_default, null, null, _parent));
			else _push(`<!---->`);
			if (!loading.value && !error.value) _push(`<hr data-v-fcb57cc6>`);
			else _push(`<!---->`);
			_push(`</div><hr data-v-fcb57cc6><!--]-->`);
		};
	}
});
//#endregion
//#region src/pages/ProjectDetail.vue
var _sfc_setup = ProjectDetail_vue_vue_type_script_setup_true_lang_default.setup;
ProjectDetail_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/ProjectDetail.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var ProjectDetail_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ProjectDetail_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-fcb57cc6"]]);
//#endregion
export { ProjectDetail_default as default };
