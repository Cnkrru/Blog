...
var useArticlesStore = defineStore("articles", () => {
	...
	const mdModules = {
		.../* @__PURE__ */ Object.assign({
			"../pages/post/post-0.md": () => import("./assets/post-0-D-jTHHjx.js").then((m) => m["default"]),
			"../pages/post/post-1.md": () => import("./assets/post-1-DRzNS1IY.js").then((m) => m["default"]),
			"../pages/post/post-2.md": () => import("./assets/post-2-C-EcnsVx.js").then((m) => m["default"]),
			"../pages/post/post-3.md": () => import("./assets/post-3-CGMZOqXJ.js").then((m) => m["default"]),
			"../pages/post/post-4.md": () => import("./assets/post-4-CvDwJpF8.js").then((m) => m["default"]),
			"../pages/post/post-5.md": () => import("./assets/post-5-BD8OhnqD.js").then((m) => m["default"]),
			"../pages/post/post-6.md": () => import("./assets/post-6-Ec6T5BDB.js").then((m) => m["default"]),
			"../pages/post/post-7.md": () => import("./assets/post-7-BXQCTXr1.js").then((m) => m["default"]),
			"../pages/post/post-8.md": () => import("./assets/post-8-D2Ib5MG2.js").then((m) => m["default"]),
			"../pages/post/post-9.md": () => import("./assets/post-9-BqjCOU4p.js").then((m) => m["default"])
		}),
		.../* @__PURE__ */ Object.assign({ "../pages/log/changelog.md": () => import("./assets/changelog-BGDbtqve.js").then((m) => m["default"]) }),
		.../* @__PURE__ */ Object.assign({ "../pages/project/project-0.md": () => import("./assets/project-0-CbjovpN8.js").then((m) => m["default"]) })
	};
	/**
...
defineStore("announcement", () => {
	...
	const loadAnnouncement = async () => {
		try {
			announcementContent.value = (await import("./assets/announcement-qPHcbVD7.js")).default;
...
var pagesDir = new URL("../pages/", import.meta.url);
var routes = [
	{
		path: "/",
		name: "Index",
		component: () => import(fileURLToPath(new URL("Index.vue", pagesDir)))
	},
	{
		path: "/home",
		name: "Home",
		component: () => import(fileURLToPath(new URL("Home.vue", pagesDir)))
	},
	{
		path: "/about",
		name: "About",
		component: () => import(fileURLToPath(new URL("About/About.vue", pagesDir)))
	},
	{
		path: "/archives",
		name: "Archives",
		component: () => import(fileURLToPath(new URL("Archives.vue", pagesDir)))
	},
	{
		path: "/links",
		name: "Links",
		component: () => import(fileURLToPath(new URL("Links.vue", pagesDir)))
	},
	{
		path: "/projects",
		name: "Projects",
		component: () => import(fileURLToPath(new URL("Projects.vue", pagesDir)))
	},
	{
		path: "/post/:id",
		name: "Post",
		component: () => import(fileURLToPath(new URL("post/Posts.vue", pagesDir)))
	},
	{
		path: "/project/:id",
		name: "Project",
		component: () => import(fileURLToPath(new URL("project/Projects.vue", pagesDir)))
	},
	{
		path: "/changelog",
		name: "Changelog",
		component: () => import(fileURLToPath(new URL("log/Changelog.vue", pagesDir)))
	},
	{
		path: "/:pathMatch(.*)*",
		name: "NotFound",
		component: () => import(fileURLToPath(new URL("NotFound.vue", pagesDir)))
	}
];
