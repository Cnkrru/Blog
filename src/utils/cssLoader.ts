...
function loadLink(id: string, href: string): void {
...
function unloadLink(id: string): void {
...
export function applyThemeCss(style: string): void {
...
export function applyLayoutCss(layout: string): void {
  if (typeof document === 'undefined') return
  // 卸载所有布局样式
